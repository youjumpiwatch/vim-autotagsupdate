if exists("loaded_AutoTagsUpdate") && g:loaded_AutoTagsUpdate
	finish
endif

let g:loaded_AutoTagsUpdate=0
...
# Disabled Disable AutoTagsUpdate_ (enable by setting to any non-blank value)
...
try:
	...
	DEBUG_NAME = "AutoTagsUpdate__debug"
